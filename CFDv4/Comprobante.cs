...
// Type: MictlanixV2.CFDv4.Comprobante
...
namespace MictlanixV2.CFDv4
{
    ...
    public class Comprobante
    {
        ...
        [XmlIgnore]
        public bool EspecificaDescuento => this.descuentoField > 0;

        public bool ShouldSerializeDescuento() => this.descuentoField > 0;
        ...
        public string SchemaLocation
        {
            get
            {
                if (this.schema_location == null)
                    this.schema_location = "http://www.sat.gob.mx/cfd/4 http://www.sat.gob.mx/sitio_internet/cfd/3/cfdv32.xsd";
        ...
        public XmlSerializerNamespaces Xmlns
        {
            get
            {
                if (this.xmlns == null)
                {
                    ...
                    this.xmlns.Add(new XmlQualifiedName("cfdi", "http://www.sat.gob.mx/cfd/4"));
